...
categoryRouter.delete(
    ...
    async (req, res, next) => {
        ...
        if (id === 1) return next(new ErrorException(400, "Default category cannot be deleted"));
        ...
        if (!defaultCategory) return next(new ErrorException(500, "Default category (id=1) not found"));
