...
bookRouter.put(
    ...
    async (req, res, next) => {
        try {
            ...
            if (!book) return next(new ErrorException(404, "Book not found"));
            ...
            if (req.body.categoryId !== undefined) book.categoryId = Number(req.body.categoryId);
            if (req.body.difficultyId !== undefined) book.difficultyId = Number(req.body.difficultyId);
            if (req.body.languageId !== undefined) book.languageId = Number(req.body.languageId);
